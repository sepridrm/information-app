    ...
    <div class="wrapper bg-white d-flex align-items-center justify-content-center overflow-hidden">
        <div class="row">
                            ...
                            <div class="col-lg-9 col-9 px-0">
                                <marquee class="mb-0 h3">
                                    ...
                                    <strong>Subuh: {{ $schedule['subuh'] }} WIB</strong> | <strong>Dzuhur:
                                        ...
                                        WIB</strong> | <strong>Magrib: {{ $schedule['maghrib'] }} WIB</strong> |
                                    <strong>Isya: {{ $schedule['isya'] }} WIB</strong>
                                </marquee>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-4">
                @if (Route::has('login'))
                    <div class="hidden m-2 text-right" style="height: 7vh">
                        <div class="py-2">
                            <x-adminlte-button theme="dark" icon="fab fa-sm fa fa-arrows-alt"
                ...
                <div class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner" style="height: 44.7vh">
                        <div class="carousel-item active">
